...
public class Practice8 {
    public static void main(String[] args) {
        //find out words that has even numbers
       String str = "The FIFA World Cup, often simply called the World Cup, is an international " +
        ...
        "global governing body. The tournament has been held every four years since the inaugural " +
        "tournament in 1930, except in 1942 and 1946 when it was not held because of the Second World War. " +
        "The reigning champions are France, who won their second title at the 2018 tournament in Russia.";
